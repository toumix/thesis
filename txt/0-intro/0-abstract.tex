...
The implementation of these QNLP models led to the development of DisCoPy, a Python library for computing with string diagrams based on a premonoidal approach to computational category theory.
We formalise our QNLP models as monoidal functors from grammar to quantum circuits and we introduce the idea of functorial learning, i.e. learning structure-preserving functors from diagram-like data.
In order to learn optimal functor parameters via gradient descent, we introduce the notion of diagrammatic differentiation, a graphical calculus for computing the gradient of quantum circuits and string diagrams in general.
\end{abstract}
