...
\begin{example}
The foo-monoidal category $\mathbf{Tensor}_\S$ (with lists of natural numbers as objects and tensors as arrows) is $\dagger$-pivotal.
...
\begin{example}
The foo-monoidal category $\mathbf{Circ}$ is $\dagger$-pivotal with the preparation of the Bell state as cap and the post-selected Bell measurement as cup (both are scaled by $\sqrt{2}$).
