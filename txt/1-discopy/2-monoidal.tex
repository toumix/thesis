...
We make the best use of Python's duck typing so that the codomain can be \py{Ty} or \py{list} indifferently, in both cases computed using the built-in \py{sum} with the \py{Ty()} or \py{[]} as unit.
