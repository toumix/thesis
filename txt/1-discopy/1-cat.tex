...
{\blue although we require it explicitly in the initialisation of a $\bf{Pyth}$ arrow}
...
{\blue In order for the quotient $M /R$ to be a monoid, don't you need to check
that multiplication is still well defined?}
