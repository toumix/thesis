...
class Function(monoidal.Function):
    ...
    def make_additive(self) -> Function:
        ...
        dom, cod = (
            ...
            else types[0].__args__ if is_union(types[0])
    ...
    def make_multiplicative(self) -> Function:
        ...
        dom, cod = (
            ...
            else types[0].__args__ if is_tuple(types[0])
            else types for types in (self.dom, self.cod))
...
DisCoPy implements free $\dagger$-biproduct completion as a subclass of \py{Matrix[Diagram]} with \py{tuple[Ty, ...]} as objects and addition given by the formal sum of diagrams.
