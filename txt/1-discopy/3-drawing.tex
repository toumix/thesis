...
All the diagrams in this thesis were drawn using DisCoPy together with TikZiT\footnote{\url{https://tikzit.github.io/index.html}} for manual editing.
...
\tikzfig{img/spiral/3}, ... \\
\vspace{5pt}
\tikzfig{img/spiral/8} $\quad \sim \quad$\footnote
{See \url{https://github.com/oxford-quantum-group/discopy/blob/main/docs/_static/imgs/spiral.gif} for a proof.} \tikzfig{img/spiral/nf}
\end{center}
\end{example}
